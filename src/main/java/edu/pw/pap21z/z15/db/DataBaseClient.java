...
public class DataBaseClient {
    ...
    private final EntityManagerFactory session = Persistence.createEntityManagerFactory("oracledb");
    private final EntityManager sessionManager = session.createEntityManager();
